      ...
      <div className="p-4">
        <div className="relative mb-2">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <Image src="/icons/search.svg" alt="" width={20} height={20} className="opacity-30" />
          </div>
          <input
            type="text"
            ...
            className="w-full pl-10 pr-4 py-3 border-b border-gray-200 outline-none placeholder-gray-300 text-black"
          />
        </div>
